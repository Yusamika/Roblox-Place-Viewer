...
window.addEventListener("load", function () {
  ...
  function UpdatePage(json) {
    ...
    HttpClientGet("https://cors-anywhere-sf.herokuapp.com/https://thumbnails.roblox.com/v1/games/icons?universeIds=" + PIDs.substr(1) + "&size=150x150&format=Png&isCircular=false",
      function (json) {
    ...
    HttpClientGet("https://cors-anywhere-sf.herokuapp.com/https://games.roblox.com/v1/games?universeIds=" + PIDs.substr(1),
      function (json) {
        for (var i = 0; i < json.data.length; i++) {
    ...
    HttpClientGet("https://cors-anywhere-sf.herokuapp.com/https://games.roblox.com/v1/games/votes?universeIds=" + PIDs.substr(1),
      function (json) {
        for (var i = 0; i < json.data.length; i++) {
  ...
  function dostuff() {
    ...
    HttpClientGet("https://cors-anywhere-sf.herokuapp.com/https://games.roblox.com/v2/users/" + ID +"/games?limit=50&cursor="+(cursorToSearch || ""), UpdatePage)
    HttpClientGet("https://cors-anywhere-sf.herokuapp.com/https://users.roblox.com/v1/users/" + ID,
      function (json) {
